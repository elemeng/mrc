...
/// Bzip2 compressor backend for [`CompressedWriter`](crate::writer::CompressedWriter).
#[derive(Debug)]
pub struct Bzip2Compressor;

impl crate::writer::Compressor for Bzip2Compressor {
...
pub type Bzip2Writer = crate::writer::CompressedWriter<Bzip2Compressor>;
