...
//! - `Plane2D` / `Plane2DMut`: 2D plane extracted from 3D volume at Z position
...
//! | Term | Meaning |
//! |------|---------|
//! | `Plane2D`, `Plane2DMut` | Geometric 2D plane in 3D space |
...
pub use volume::{Bounds, Plane2D, Plane2DMut, Volume, VolumeBuilder};
