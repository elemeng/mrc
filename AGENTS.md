...
- Built-in conversion conveniences: `slices_f32()`, `slabs_f32()`, `convert_slices::<T>()`, `convert_slabs::<T>()`, `convert_volume::<T>()`, `slices_u8()`, `slabs_u8()`, `slices_mode0()`, `slabs_mode0()`, `read_volume::<T>()`, `read_volume_f32()`, `read_volume_u8()`, `write_block_as()`, `write_u8_block()`, and `write_u4_block()`.
